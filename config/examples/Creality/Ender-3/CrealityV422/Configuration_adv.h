 ...
 */
#define CONFIG_EXPORT 2 // :[1:'JSON', 2:'config.ini', 3:'schema.json', 4:'schema.yml'] //Updated by JimmysDIY
...
// @section bltouch
  ...
  #define BLTOUCH_DELAY 500  //Updated by JimmysDIY
  ...
  #define BLTOUCH_FORCE_SW_MODE //Updated by JimmysDIY
   ...
   */
  #define BLTOUCH_HS_MODE true //Updated by JimmysDIY
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  #define PROBE_OFFSET_WIZARD       // Add a Probe Z Offset calibration option to the LCD menu //Updated by JimmysDIY
     ...
     */
    #define PROBE_OFFSET_WIZARD_START_Z -4.0 //Updated by JimmysDIY
  ...
  #define STATUS_MESSAGE_SCROLLING  //Updated by JimmysDIY
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define SHOW_ELAPSED_TIME               // Display elapsed printing time (prefix 'E') //Updated by JimmysDIY
  #define SHOW_REMAINING_TIME           // Display estimated time to completion (prefix 'R')  //Updated by JimmysDIY
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_DISPLAY_TOTAL          // Display total babysteps since last G28 //Updated by JimmysDIY

  #define BABYSTEP_ZPROBE_OFFSET          // Combine M851 Z and Babystepping  //Updated by JimmysDIY
...
// G2/G3 Arc Support
//
#define ARC_SUPPORT                   // Requires ~3226 bytes  //Updated by JimmysDIY
 ...
 */
#define ADVANCED_PAUSE_FEATURE  //JimmysDIY
 ...
 */
#define HOST_ACTION_COMMANDS  //Updated by JimmysDIY
#if ENABLED(HOST_ACTION_COMMANDS)
  #define HOST_PAUSE_M76                // Tell the host to pause in response to M76  //Updated by JimmysDIY
  #define HOST_PROMPT_SUPPORT           // Initiate host prompts to get user feedback  //Updated by JimmysDIY
  #if ENABLED(HOST_PROMPT_SUPPORT)
    #define HOST_STATUS_NOTIFICATIONS   // Send some status messages to the host as notifications  //Updated by JimmysDIY
  #endif
